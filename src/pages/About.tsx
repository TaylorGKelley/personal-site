			...
			<section className='grid sm:grid-cols-2 md:gap-16 gap-8 sm:py-36 py-20'>
				...
				<div>
					...
					<a
						...
						target='_blank'
						className='flex gap-2 items-center pl-4 pr-5 py-2 rounded-2xl hover:bg-gray-800/90 dark:hover:bg-gray-50/90 text-white dark:text-black transition-colors cursor-pointer bg-gray-800 dark:bg-gray-50 w-min'>
